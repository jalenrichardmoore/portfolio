...
import { heroSection, overviewSection, featuresSection, gallery, developerNote, links } from '../../data/sentimentAnalysisData';

function SentimentAnalysis() {
    useEffect(() => {
                document.title = 'Jalen Moore | Movie Review Sentiment Analysis';
    }, []);
