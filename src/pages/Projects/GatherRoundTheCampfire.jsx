...
import { heroSection, overviewSection, featuresSection, gallery, developerNote, links } from '../../data/gatherRoundTheCampfireData';

function GatherRoundTheCampfire() {
    useEffect(() => {
                document.title = 'Jalen Moore | Gather \'Round the Campfire';
    }, []);
...
export default GatherRoundTheCampfire;