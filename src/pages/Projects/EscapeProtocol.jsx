...
import { heroSection, overviewSection, featuresSection, gallery, developerNote, links } from '../../data/escapeProtocolData';

function EscapeProtocol() {
    useEffect(() => {
                document.title = 'Jalen Moore | Escape Protocol';
    }, []);
